   ...
   <Reveal>
     ...
     <div className='border rounded-lg p-4 bg-white shadow-md'>
        <Link to={`/blogs/${blog?._id}`}>
            <img src={blog.image} alt="blog image" className='w-full h-48 object-cover rounded-md mb-4 hover:scale-105 transition-all duration-200 cursor-pointer' />
        </Link>
        <div>
            ...
            <div className='mt-4 flex items-center'>
                <img src={blog.author.image} alt="author" className='size-10 rounded-full mr-3' />
                <div>
